...
export const AuthorDeleteDialog = (props: IAuthorDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.delete.question">
        <Translate
          contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.delete.question"

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.home.createOrEditLabel">
            <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.home.createOrEditLabel">
            ...
            <AvForm model={isNew ? {} : authorEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="author-name">
                  <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.name">Name</Translate>
                </Label>
                <AvField
                  id="author-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="addressLabel" for="author-address">
                  <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.address">Address</Translate>
                </Label>
                <AvField id="author-address" type="text" name="address" />
              </AvGroup>

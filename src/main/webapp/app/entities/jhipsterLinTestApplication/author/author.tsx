  ...
  return (
    <div>
      <h2 id="author-heading">
        <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.home.title">Authors</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.home.createLabel">Create new Author</Translate>
        </Link>
      </h2>
          ...
          {authorList && authorList.length > 0 ? (
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationAuthor.home.notFound">
                  No Authors found
                </Translate>
              </div>
            )

...
export const ArticleDeleteDialog = (props: IArticleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterlintestgatewayApp.jhipsterLinTestApplicationArticle.delete.question">
        <Translate
          contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationArticle.delete.question"
          interpolate={{ id: articleEntity.id }}
        >

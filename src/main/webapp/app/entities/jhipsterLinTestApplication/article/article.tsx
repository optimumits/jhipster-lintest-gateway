  ...
  return (
    <div>
      <h2 id="article-heading">
        <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationArticle.home.title">Articles</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationArticle.home.createLabel">
            Create new Article
          </Translate>
        </Link>
      </h2>
          ...
          {articleList && articleList.length > 0 ? (
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterlintestgatewayApp.jhipsterLinTestApplicationArticle.home.notFound">
                  No Articles found
                </Translate>
              </div>
            )

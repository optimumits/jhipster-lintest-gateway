...
@RestController
@RequestMapping("/api/jhipsterlintestgateway-kafka")
public class JhipsterlintestgatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterlintestgatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterlintestgatewayKafkaResource(KafkaProperties kafkaProperties) {

...
import com.optimumits.lintest.gateway.config.KafkaProperties;
...
class JhipsterlintestgatewayKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterlintestgatewayKafkaResource kafkaResource = new JhipsterlintestgatewayKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipsterlintestgateway-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipsterlintestgateway-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
